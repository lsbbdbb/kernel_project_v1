...
class TestPatchParser:
    ...
    def test_parse_patch_basic(self):
        parser = PatchParser(self.tmpdir, "CVE-2025-21638")
    ...
    def test_change_units_generated(self):
        ...
        change_path = os.path.join(self.tmpdir, "CVE-2025-21638", "change_units.json")
    ...
    def test_patch_ir_saved(self):
        parser = PatchParser(self.tmpdir, "CVE-2025-21638")
        parser.parse_patch(self.patch_path)
        ir_path = os.path.join(self.tmpdir, "CVE-2025-21638", "patch_ir.json")
